<div class="header">
    <div class="logo logo-dark">
        <a href="{{ route('admin.index') }}">
            ...
            <img class="logo-fold" src="{{ asset('assets/admin/images/logo/logo-fold.png') }}" alt="Logo">
        </a>
    </div>
            ...
            <li class="dropdown dropdown-animated scale-left">
                <div class="pointer" data-toggle="dropdown">
                    <div class="avatar avatar-image  m-h-10 m-r-15">
                        <img src="{{ asset('assets/admin/images/avatars/blank.png') }}" alt="">
                    </div>
                </div>
                <div class="p-b-15 p-t-20 dropdown-menu pop-profile">
                    <div class="p-h-20 p-b-15 m-b-10 border-bottom">
                        <div class="d-flex m-r-50">
                            ...
                            <div class="m-l-10">
                                ...
                                <p class="m-b-0 opacity-07">{{ auth()->user()->roles()->first()->name }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    {{--                        </div>--}}
                    {{--                    </a>--}}
                    <a class="dropdown-item d-block p-h-15 p-v-10"
                            onclick="$('#logout-form').submit()"  style="cursor: pointer">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
