                            ...
                            <table class="table table-hover">
                                    ...
                                    <td>
                                        <div class="media align-items-center">
                                            <div class="avatar avatar-image rounded">
                                                <img src="{{ asset('assets/admin/images/others/thumb-9.jpg') }}" alt="">
                                            </div>
                                            <div class="m-l-10">
                                                <span>Gray Sofa</span>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="media align-items-center">
                                            <div class="avatar avatar-image rounded">
                                                <img src="{{ asset('assets/admin/images/others/thumb-10.jpg') }}" alt="">
                                            </div>
                                            <div class="m-l-10">
                                                <span>Gray Sofa</span>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="media align-items-center">
                                            <div class="avatar avatar-image rounded">
                                                <img src="{{ asset('assets/admin/images/others/thumb-11.jpg') }}" alt="">
                                            </div>
                                            <div class="m-l-10">
                                ...
                                <tr>
                                    <td>
                                        <div class="media align-items-center">
                                            <div class="avatar avatar-image rounded">
                                                <img src="{{ asset('assets/admin/images/others/thumb-12.jpg') }}" alt="">
                                            </div>
                                            <div class="m-l-10">
                                                <span>Red Chair</span>
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="media align-items-center">
                                            <div class="avatar avatar-image rounded">
                                                <img src="{{ asset('assets/admin/images/others/thumb-13.jpg') }}" alt="">
                                            </div>
                                            <div class="m-l-10">
                                                <span>Wristband</span>
                                            </div>
